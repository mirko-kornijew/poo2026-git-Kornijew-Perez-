<<<<<<< HEAD
# Los diez comandos de la clase

Hoja de referencia. Con esto alcanza para toda la actividad.
...
## Prohibidos por ahora

`git reset --hard` · `git rebase` · `git push --force`

Los tres pueden destruir trabajo propio o del equipo, y no los necesitamos todavía.
=======
# Los diez comandos de la clase
